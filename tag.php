  ...
  <div id="container">
   <div id="content">
	...
	<div class="results-title">
		...
		<div class="lower"></div>
		<div class="cont">  
			<h1 class="page-title"><?php _e( 'Tag Archives:' ) ?> <span><?php single_tag_title() ?></span></h1>
		</div>
	</div>
<?php rewind_posts(); ?>
...
<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&raquo;</span>' )  ); ?>
     ...
     <div class="entry-utility">
      ...
      <?php if ( $tag_ur_it = tag_ur_it(', ') ) : // Returns tags other than the one queried ?>      
        <span class="tag-links"><span class="icon"></span><?php printf( __( 'Also tagged %s'), $tag_ur_it ) ?></span><br />
      <?php endif; ?>
