   ...
   <div id="content">
	...
	<stop></stop>
 	<div class="results-title">
		...
		<div class="lower"></div>
		<div class="cont">  
			<h1 class="page-title"><?php _e( 'Category Archives:') ?> <span><?php single_cat_title() ?></span></span></h1>
...
<?php the_excerpt( __( 'Continue reading <span class="meta-nav">&raquo;</span>')  ); ?>
     ...
     <div class="entry-utility">
      <?php if ( $cats_meow = cats_meow(', ') ) : // Returns categories other than the one queried ?>
        <span class="cat-links"><span class="icon"></span><?php printf( __( 'Also posted in %s'), $cats_meow ) ?></span><br />
      <?php endif ?>
